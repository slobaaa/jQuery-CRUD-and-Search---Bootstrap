...
$(function() {
    $( "#txtDate" ).datepicker({ minDate: -50000, maxDate: "+0M +0D" });
});
...
function dodajZaposlenog() {
	...
	let datum=$("#txtDate").val();
	let email=$("#txtEmail").val();
	let zaDodavanje = "<tr><td onclick='izmeniZaposlenog(this)' for='ime' style='cursor: pointer;'>" + ime + 
	"</td><td onclick='izmeniZaposlenog(this)' for='prezime' style='cursor: pointer;'>" + prezime + 
	"</td><td onclick='izmeniZaposlenog(this)' for='datum' style='cursor: pointer;'>" + datum + 
	"</td><td onclick='izmeniZaposlenog(this)' for='email' style='cursor: pointer;'>" + email + 
	"</td><td class='text-right'><i class='material-icons brisi' style='font-size:36px; cursor: pointer;'>highlight_off</i></td></tr>";
